...
const categories = computed(() => frontmatter.value?.categories?.split(','));
const date = frontmatter.value?.date ? formatDate(frontmatter.value.date) : undefined;
</script>
<template>
